...
Route::group(['middleware' => ['auth']], function () {
    Route::group(['prefix' => 'roles', 'as' => 'roles.'], function () {
        ...
        Route::post('/update', [RoleController::class, 'update'])->name('update')->middleware('permission:role_edit');
    ...
    Route::group(['prefix' => 'devices', 'as' => 'devices.'], function () {
        ...
        Route::get('/showgraph/{id}', [DeviceController::class, 'showgraph'])->name('showgraph') /*->middleware('permission:device_showgraph')*/;
